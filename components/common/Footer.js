          ...
          <Box sx={{ padding: { xs: 1, md: 3 } }}>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} lg={8}>
                ...
                <Typography>
                  Chào mừng bạn đến với nền tảng nội dung số dành cho người
                  Việt. Tại đây chúng tôi cho phép đăng tải những tác phẩm văn
                  học, tiểu thuyết do chính bạn sáng tạo ra. Với tôn chỉ vì một
                  nền văn học mạng Việt Nam phát triển bền vững, chúng tôi sẽ
                  mang đến cho tác giả và người đọc Tiếng Việt trên toàn thế
                  giới một môi trường công nghệ tiên tiến, công cụ quản lý
                  chuyên nghiệp, mô hình hoạt động công bằng nhằm thúc đẩy sáng
                  tạo đến tận cùng.
                </Typography>
              </Grid>
